...
class SquareShapeFactory: ShapeFactory {
    ...
    func createShapes() -> (Shape, Shape) {
        ...
        shape1.sideLength = Utils.randomBetweenLower(minProportion, upper: maxProportion)
        
        let shape2 = SquareShape()
        shape2.sideLength = Utils.randomBetweenLower(minProportion, upper: maxProportion)
...
class CircleShapeFactory: ShapeFactory {
    ...
    func createShapes() -> (Shape, Shape) {
        ...
        shape1.diameter = Utils.randomBetweenLower(minProportion, upper: maxProportion)
        
        let shape2 = CircleShape()
        shape2.diameter = Utils.randomBetweenLower(minProportion, upper: maxProportion)
